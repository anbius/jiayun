...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?>| 嘉云健康</title>
    <link href="/Public/favicon.ico" type="image/x-icon" rel="shortcut icon"><!--zui-->
...
<div class="panel-menu">
    <ul class="nav nav-primary nav-stacked">
        ...
        <?php if(is_array($__MODULE_MENU__)): $i = 0; $__LIST__ = $__MODULE_MENU__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v['is_setup'] AND $v['admin_entry'] AND $v['show_nav']): ?><li>
