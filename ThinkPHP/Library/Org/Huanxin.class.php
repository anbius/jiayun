...
class Huanxin{
	 ...
	 * 环信-服务器端REST API
	 */
	private $client_id = 'YXA6J7AzcBQQEea53ZPdhD5ung';
	private $client_secret = 'YXA64LGFm_iJj-Nh_Mz_TO7859mg3IA';
	private $org_name = 'jianongzx';
	private $app_name = 'jiayunjiankang';
	private $url = 'https://a1.easemob.com/jianongzx/jiayunjiankang/';
	/**
	 * 开放注册模式
	 *
	...
	public function isOnline($username) {
		...
		$status = $rs->data->$username;
		return is_null($status)?'offline':$status;
	}
	/**
	 * 发送消息
	 *
